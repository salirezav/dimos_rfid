...
for f in demo_blueprint.py go2_blueprints.py go2_agentic_blueprints.py recorder.py msgs.py rfid_module.py rfid_rerun.py rfid_spatial.py _backend.py; do
    cp "${SCRIPT_DIR}/${f}" "${RFID_DIR}/${f}"
done

for f in demo_blueprint.py go2_blueprints.py go2_agentic_blueprints.py recorder.py rfid_module.py rfid_rerun.py rfid_spatial.py; do
    sed -i \
